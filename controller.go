...
import (
	...
	samplecrdv1 "k8s.io/some/pkg/apis/samplecrd/v1"
	clientset "k8s.io/some/pkg/client/clientset/versioned"
	networkscheme "k8s.io/some/pkg/client/clientset/versioned/scheme"
	informers "k8s.io/some/pkg/client/informers/externalversions/samplecrd/v1"
	listers "k8s.io/some/pkg/client/listers/samplecrd/v1"
)
