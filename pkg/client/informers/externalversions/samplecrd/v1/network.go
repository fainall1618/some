...
import (
	...
	versioned "k8s.io/some/pkg/client/clientset/versioned"
	internalinterfaces "k8s.io/some/pkg/client/informers/externalversions/internalinterfaces"
	v1 "k8s.io/some/pkg/client/listers/samplecrd/v1"
)
